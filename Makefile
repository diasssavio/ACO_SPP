...
$(TMP_ILS)/aco.o: $(SRC)/aco.cpp $(INCLUDE)/aco.h
	$(CCC) -c $(CCFLAGS) $(SRC)/aco.cpp -o $(TMP_ILS)/aco.o
...
$(CPP_EX): $(TMP_ILS)/instance.o $(TMP_ILS)/solution.o $(TMP_ILS)/FWChrono.o $(TMP_ILS)/mt19937ar.o $(TMP_ILS)/logger.o $(TMP_ILS)/neighborhoods.o $(TMP_ILS)/aco.o $(TMP_ILS)/main.o
	$(CCC)  $(CCFLAGS) $(TMP_ILS)/instance.o $(TMP_ILS)/solution.o $(TMP_ILS)/FWChrono.o $(TMP_ILS)/mt19937ar.o $(TMP_ILS)/logger.o $(TMP_ILS)/neighborhoods.o $(TMP_ILS)/aco.o $(TMP_ILS)/main.o -L$(TMP_STATIC) -o $(CPP_EX)
#endif
